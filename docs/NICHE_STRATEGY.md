...
|---|---|---|---|---|---|---|
| `bjj` | BJJ tribe | `/bjj/about.html` | jf-hero | ¥80K | ¥500K | 100 |
| `founder` | Founder Edition (luxury) | `/buy/founder` | hero-on-model | ¥20K | ¥200K | 80 |
| `collab` | B2B Collab (rev share) | `/bjj/about.html` | jf-hero | ¥0 | ¥100K | 70 |
...
**入口**: `/bjj/about.html` (Why BJJ + 4 pillars + creator profile) → `/buy/event` (5/24 SUZURI ¥4,900)
...
4. 着用 photo 来たら status='photo_received' → /bjj/about.html の social proof セクション に 載せる
...
**入口**: `/bjj/about.html` の B2B CTA (`bjj@enablerdao.com` mailto)
...
私 の 経歴: https://wearmu.com/bjj/about.html
...
取材 ご検討 いただけたら 嬉しい です。 wearmu.com / wearmu.com/bjj/about.html
...
- [ ] 着用 photo を /bjj/about.html + /buy/event に 追加
...
- [x] /bjj/about.html — MU × BJJ strategic LP (4 pillars + creator profile + B2B CTA)

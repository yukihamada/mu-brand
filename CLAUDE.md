...
> Amazonは「買うこと」を、メルカリは「売ること」を空気にした。
...
結論: MU単独で一般アパレルを狙わない。**実需のある JiuFlow(BJJ) に MU の作る技術を従属**させ、一次→二次を自然に生やす。
...
**やらない**: 自社中古倉庫 / 量産品の中古化 / 低単価NFT / 手数料値下げ戦争 / 外部フリマの出品データ転載(価格集計のみ)。

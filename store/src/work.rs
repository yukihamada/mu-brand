...
<tr><td>単価</td><td><b>出来高制・着手する前に「1件いくら」を必ず表示</b>します。Tシャツの仕上げは目安 <b>¥200前後/件</b>（1件数分）、音コインは ¥{fee}/件。1件あたりが数分で終わる軽作業の単価です。</td></tr>
...
<p><b>Q. 写真の承認が落ちることはある？</b><br>たたみ方やカードの入れ忘れなど、まれにやり直しをお願いすることがあります。その場合は<b>どこを直すか具体的にお伝えし、直してもらえれば報酬は支払われます</b>。理由なく落とすことはありません。ミスでお客様に再発送が必要になっても、費用はあなたに請求しません。</p>
